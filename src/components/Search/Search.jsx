  ...
  return (
    <>
      <form className={style.form}>
        <input className="search" type="search" placeholder='Input Blogger blog for search' />
        <button className='search__btn'>
          <svg className='search__svg' width="128" height="128" viewBox="0 0 128 128" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
